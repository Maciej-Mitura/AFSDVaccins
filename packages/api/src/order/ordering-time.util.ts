...
export function addLocalDays(parts: ZonedDateParts, days: number): ZonedDateParts {
...
export function resolveDeliveryDate(
  ...
  if (isAfterClosingTime(instant, timeZone, closingTime)) {
