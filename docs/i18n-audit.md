...
Key counts: nl=1175, en=1175, es=1175, zh=1175
...
Count: **76** (heuristic harvest — may include dynamic-only keys).

Do **not** delete in this phase unless clearly dangerous duplicates. Listed as `UNUSED` in the CSV.

## 8. Terminology consistency

- Courier-related keys: 285; pharmacist/pharmacy-related keys: 112. Prefer "bezorger"/"apotheker" in Dutch UI and "courier"/"pharmacist" in English.
